...
struct HelpCard_Previews: PreviewProvider {
    static var previews: some View {
        HelpCard(helpModel: HelpModel(title: "Pode crerrr", description: "jsdnjsnajksdnjlsanjsdn asnjasnsdj asnsajn asndsjns", type: .business, currentLocation: "Caverna de cima", requestDate: Date()))
    }
}
